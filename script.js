...
var img1 = document.querySelector(".card:nth-child(1) img:nth-child(1)");
img1.src = productList[0].preview;
var text1 = document.querySelector(".card:nth-child(1) h5:nth-child(1)");
text1.textContent = productList[0].name
var para1 = document.querySelector(".card:nth-child(1) p:nth-child(2)");
para1.textContent = productList[0].brand
var price1 = document.querySelector(".card:nth-child(1) p:nth-child(3)");
price1.textContent = "Rs" + " " + productList[0].price
var img2 = document.querySelector(".card:nth-child(2) img:nth-child(1)");
img2.src = productList[1].preview;
var text2 = document.querySelector(".card:nth-child(2) h5:nth-child(1)");
text2.textContent = productList[1].name
var para2 = document.querySelector(".card:nth-child(2) p:nth-child(2)");
para2.textContent = productList[1].brand
var price2 = document.querySelector(".card:nth-child(2) p:nth-child(3)");
price2.textContent = "Rs" + " " + productList[1].price
var img3 = document.querySelector(".card:nth-child(3) img:nth-child(1)");
img3.src = productList[2].preview;
var text4 = document.querySelector(".card:nth-child(3) h5:nth-child(1)");
text4.textContent = productList[2].name
var para3 = document.querySelector(".card:nth-child(3) p:nth-child(2)");
para3.textContent = productList[2].brand
var price3 = document.querySelector(".card:nth-child(3) p:nth-child(3)");
price3.textContent ="Rs" + " " + productList[2].price
var img4 = document.querySelector(".card:nth-child(4) img:nth-child(1)");
img4.src = productList[3].preview;
var text4 = document.querySelector(".card:nth-child(4) h5:nth-child(1)");
text4.textContent = productList[3].name
var para4 = document.querySelector(".card:nth-child(4) p:nth-child(2)");
para4.textContent = productList[3].brand
var price4 = document.querySelector(".card:nth-child(4) p:nth-child(3)");
price4.textContent = "Rs" + " " + productList[3].price
var img5 = document.querySelector(".card:nth-child(5) img:nth-child(1)");
img5.src = productList[4].preview;
var text5 = document.querySelector(".card:nth-child(5) h5:nth-child(1)");
text5.textContent = productList[4].name
var para5 = document.querySelector(".card:nth-child(5) p:nth-child(2)");
para5.textContent = productList[4].brand
var price5 = document.querySelector(".card:nth-child(5) p:nth-child(3)");
price5.textContent ="Rs" + " " + productList[4].price


var img6 = document.querySelector(".card_flex2 .card:nth-child(1) img:nth-child(1)");
img6.src = productList[5].preview;
var text6 = document.querySelector(".card_flex2 .card:nth-child(1) h5:nth-child(1)");
text6.textContent = productList[5].name
var para6 = document.querySelector(".card_flex2 .card:nth-child(1) p:nth-child(2)");
para6.textContent = productList[5].brand
var price6 = document.querySelector(".card_flex2 .card:nth-child(1) p:nth-child(3)");
price6.textContent = "Rs" + " " + productList[5].price
var img7 = document.querySelector(".card_flex2 .card:nth-child(2) img:nth-child(1)");
img7.src = productList[6].preview;
var text7 = document.querySelector(".card_flex2 .card:nth-child(2) h5:nth-child(1)");
text7.textContent = productList[6].name
var para7 = document.querySelector(".card_flex2 .card:nth-child(2) p:nth-child(2)");
para7.textContent = productList[6].brand
var price7 = document.querySelector(".card_flex2 .card:nth-child(2) p:nth-child(3)");
price7.textContent = "Rs" + " " + productList[6].price
var img8 = document.querySelector(".card_flex2 .card:nth-child(3) img:nth-child(1)");
img8.src = productList[7].preview;
var text8 = document.querySelector(".card_flex2 .card:nth-child(3) h5:nth-child(1)");
text8.textContent = productList[7].name
var para8 = document.querySelector(".card_flex2 .card:nth-child(3) p:nth-child(2)");
para8.textContent = productList[7].brand
var price8 = document.querySelector(".card_flex2 .card:nth-child(3) p:nth-child(3)");
price8.textContent ="Rs" + " " + productList[7].price
var img9 = document.querySelector(".card_flex2 .card:nth-child(4) img:nth-child(1)");
img9.src = productList[8].preview;
var text9 = document.querySelector(".card_flex2 .card:nth-child(4) h5:nth-child(1)");
text9.textContent = productList[8].name
var para9 = document.querySelector(".card_flex2 .card:nth-child(4) p:nth-child(2)");
para9.textContent = productList[8].brand
var price9 = document.querySelector(".card_flex2 .card:nth-child(4) p:nth-child(3)");
price9.textContent = "Rs" + " " + productList[8].price
var img10 = document.querySelector(".card_flex2 .card:nth-child(5) img:nth-child(1)");
img10.src = productList[9].preview;
var text10 = document.querySelector(".card_flex2 .card:nth-child(5) h5:nth-child(1)");
text10.textContent = productList[9].name
var para10 = document.querySelector(".card_flex2 .card:nth-child(5) p:nth-child(2)");
para10.textContent = productList[9].brand
var price10 = document.querySelector(".card_flex2 .card:nth-child(5) p:nth-child(3)");
price10.textContent ="Rs" + " " + productList[9].price